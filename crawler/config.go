...
type CrawlerConfig struct {
	...
	WorkflowMaxTasks         int               `json:"workflow_max_tasks"`
	RouteTemplateSampleLimit int               `json:"route_template_sample_limit"`
	RecordActionSampleLimit  int               `json:"record_action_sample_limit"`
...
func DefaultCrawlerConfig() CrawlerConfig {
	return CrawlerConfig{
		...
		WorkflowMaxTasks:         200,
		RouteTemplateSampleLimit: 3,
		RecordActionSampleLimit:  3,
		UseKatana:                false,
